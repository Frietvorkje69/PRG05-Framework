            ...
            <div class="mb-4 col-6">
                ...
                <div>
                    @can('create', \App\Models\Product::class)
                        <btn class="btn btn-info"><a href="{{route('products.create')}}" class="link page-link">Add new product</a></btn>
                    @endcan
                </div>
                ...
                @foreach($products as $product)
                    <div class="card">
                        <div class="card-header"><h1><a href="/products/{{$product->id}}"
                            ...
                            @can('update', $product)
                                <a class="btn btn-secondary" href="{{route('products.edit', $product->id)}}">
